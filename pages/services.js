                ...
                <div className="section section--dark">
                    <div className="container pr-5">
                        <h2 className="section__title--light">We <span
                            className="text-primary">design, develop, test,</span> and <span
                            className="text-primary">deliver</span> your projects quickly and reliably</h2>
                    ...
                    <div className="container">
                        ...
                        <div className="flex-row pt-5">
                            <div className="justify-content-center col-md-4 mb-md-0 mb-4">
                                <Card cardLink="https://github.com/SolidStateGroup/rio" cardTechnology={'JavaScript'}
                                      cardTechnologyStars={'120'} cardTechnologyForked={'14'}
                                      techColourClass={'card__technology--yellow'} cardTitle={'rio'}/>
                            </div>
                            <div className="justify-content-center col-md-4 mb-md-0 mb-4">
                                <Card cardLink="https://github.com/SolidStateGroup/bullet-train-aio"
                            ...
                            <div className="justify-content-center col-md-4">
                                <Card cardLink="https://github.com/SolidStateGroup/patientview" cardTechnology={'Java'}
