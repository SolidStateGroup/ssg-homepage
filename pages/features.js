                  ...
                  <div className="container-fluid mb-4">
                      <div className="col-lg-8 offset-lg-2 col-xl-6 offset-xl-3 text-center mb-5">
                          ...
                          <div className="col-lg-8 offset-lg-2">
                              <p>Features dont have to be Yes/No boolean values with remote config. You can specify String, number or
                  boolean values and override them whenever you like.
                              </p>
                          ...
                          <div className="col-md-3 offset-md-2 align-self-center">
                              <div className="card card--navy card--code">
                                  <div className="card-body">
                                      ...
                                      <pre className="battery-log" id="increment-numbers"><span className="code code--green">height:2em
                                      </span>
                                      </pre>
                                  </div>
                              </div>
                  ...
                  <div className="container">
                      <div className="row pt-5 pb-5">
                          ...
                          <div className="col-md-1 offset-md-2 hidden-sm-down">
                              <img src="/static/images/features-page/user-traits-steps.svg" alt="User Traits" className="img-fluid"/>
                          </div>
