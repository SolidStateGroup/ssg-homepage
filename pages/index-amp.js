...
import Hero from '../components/HeroAMP';
import Footer from '../components/FooterAMP';
...
const Guide = props => (
    <div>
        <div onClick={() => window.location = props.href} style={{ cursor: 'pointer', color: 'white', width: 360, alignItems: 'center', height: 183, backgroundColor: '#1d2d3f', display: 'flex', justifyContent: 'center', flexDirection: 'column' }}>
            <amp-img
              width={props.width} height={props.height} style={{ marginBottom: props.title ? 10 : 0 }}
                          ...
                          <div className="row">
                              <div className="col-md-1 col-xs-6">
                                  <a href="https://docs.bullet-train.io/clients/java/">
                                      <amp-img
                                        width="50px" height="50px" src="/static/images/tech-logos/java.png"
                                        alt="Java" title="Java"
                                      />
                                  </a>
                              </div>
                              <div className="col-md-1 col-xs-6">
                                  <a href="https://docs.bullet-train.io/clients/javascript/">
                                      <amp-img
                                        width="50px" height="50px" src="/static/images/tech-logos/javascript.png"
                              ...
                              <div className="col-md-1 col-xs-6">
                                  <a href="https://docs.bullet-train.io/clients/javascript/">
                                      <amp-img
                                        width="50px" height="50px" src="/static/images/tech-logos/react.png"
                              ...
                              <div className="col-md-1 col-xs-6">
                                  <a href="https://docs.bullet-train.io/clients/node/">
                                      <amp-img
                                        width="50px" height="50px" src="/static/images/tech-logos/node.png"
                              ...
                              <div className="col-md-1 col-xs-6">
                                  <a href="https://docs.bullet-train.io/clients/ruby/">
                                      <amp-img
                                        width="50px" height="50px" src="/static/images/tech-logos/ruby.png"
                                        alt="Ruby" title="Ruby"
                                      />
                                  </a>
                              </div>
                              <div className="col-md-1 col-xs-6">
                                  <a href="https://docs.bullet-train.io/clients/dotnet/">
                                      <amp-img
                                        width="50px" height="50px" src="/static/images/tech-logos/dotnet.png"
                                        alt=".NET" title=".NET"
                                      />
                                  </a>
                              </div>
                              <div className="col-md-1 col-xs-6">
                                  <a href="https://docs.bullet-train.io/clients/java/">
                                      <amp-img
                                        width="50px" height="50px" src="/static/images/tech-logos/android2x.png"
                              ...
                              <div className="col-md-1 col-xs-6">
                                  <a href="https://docs.bullet-train.io/clients/ios/">
                                      <amp-img
                                        width="50px" height="50px" src="/static/images/tech-logos/bt-IOS.png"
                                        alt="IOS" title="IOS"
                                      />
                                  </a>
                              </div>
                  ...
                  Bullet Train combines the concepts of feature toggles with the flexibility of remote config. Rather than just switching features on and off, you can configure them for individual segments, users and development environments.
                          ...
                          <div className="col-md-8 text-right">
                              <amp-img
                                ...
                                width="441px"
                                height="272px"
                                style={{ maxWidth: '100%' }} alt="Feature use cases" src="/static/images/homepage-features.png"
                              />
                          </div>
                      </div>
                  </div>
                          ...
                          <div className="col-md-8">
                              <div className="text-left">
                                  <amp-img
                                    ...
                                    width="616px"
                                    height="462px"
                                    style={{ maxWidth: '100%' }} alt="User segmentation and ab testing" src="/static/images/homepage-segments.png"
                                  />
                              </div>
                          </div>
                          <div className="col-md-4">
              ...
              <div className="sign-up" id="sign-up">
                  <div>
                      <div className="card signup-form container animated fadeIn col-md-8 col-xl-8">
                          <form
                            action-xhr="https://bullet-train.io"
                            target="_blank"
