        ...
        return (
            <React.Fragment>
                <Page title={Constants.titles.zopa} canonical="projects/racing-post">
                    <ProjectHero
                      clientImage="/images/clients/white/zopa-white.svg"
                    ...
                    <div className="container">
                        ...
                        <div>
                            <ProjectDetailSectionItem
                              ...
                              imageOne="/images/projects/zopa/zopa-2.png"
                              srcSetImageOne="/images/projects/zopa/zopa-2.png 1x, /images/projects/zopa/zopa-2@2x.png 2x"
                            />
                        </div>
                    ...
                    <ProjectFullImageSection
                        ...
                        subTitle={'02 / Rebuild of API services'}
                        imageUrl={'/images/projects/zopa/zopa-3.png'}
                        srcSet={'/images/projects/zopa/zopa-3.png 1x, /images/projects/zopa/zopa-3@2x.png 2x'}
                          ...
                          techLogoItems={(
                              <React.Fragment>
                                  <div className="col-6 pt-5 pt-lg-0 text-center">
                                      <img src="/images/tech-icons/dark/kotlin.svg" className="img-responsive"/>
                                  </div>
                                  ...
                                  <div className="col-6 pt-5 pt-lg-0 text-center">
                                      <img src="/images/tech-icons/dark/firebase.svg" className="img-responsive"/>
                                  </div>
                                  <div className="col-6 pt-5 text-center">
                                      <img src="/images/tech-icons/dark/kafka.svg" className="img-responsive"/>
                                  </div>
                              </React.Fragment>
)}
                        />
