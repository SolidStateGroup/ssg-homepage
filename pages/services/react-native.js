            ...
            <Page title={Constants.titles.reactNative} canonical="react-native">
                <div className="hero d-flex flex-column mx-0 pt-4 pr-4 pb-0 pl-4">
                    ...
                    <ServicesHero
                      title="React Native"
                      text={<>
                          {'We use React Native to build \n'} <Link prefetch={false} href="/services/mobile-app-development">
                        amazing mobile apps
                          </Link> {'Why?\n'
                ...
                <div className="container">
                    <ServiceItem
                      serviceImage="/images/services/rn-apps.png"
                      className="flex-row"
                    ...
                    <ServiceItem
                      ...
                      serviceDescription={<>
                          {'React allows us to \n'} <Link prefetch={false} href="/services/mobile-app-development">
                          build mobile apps
                                                    </Link> {'for iOS and Android at the same time with a shared application logic. There\'s an added benefit of shared application code for web applications as well.'}
                      </>}
