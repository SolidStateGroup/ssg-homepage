        ...
        return (
            <Page title={Constants.titles.userResearch} canonical="user-research">
                <div className="hero d-flex flex-column mx-0 pt-4 pr-4 pb-0 pl-4">
                    <Header/>
                    <ServicesHero title="User Research" text="We conduct detailed user research with rigour and detail that is flexible depending on your project and budget. Executing user research and usability testing results in a better user experience for your users and saves you time and money in the long run by identifying and fixing problems early." />
                </div>
