...
const TheComponent = class extends Component {
    ...
    componentDidMount() {
        API.trackPage(Constants.pages.serviceFitness);
    }

    render() {
        return (
          <React.Fragment>
              <Page title={Constants.titles.fitness} canonical="services/fitness">
                  <ProjectHero
                    projectTitle="Built specifically for your trainers and audience"
                    projectType="Bespoke Fitness Apps"
