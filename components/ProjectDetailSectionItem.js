                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 d-flex">
                            <div className="flex-row">
                                <div className="col-md-6 align-self-end">
                                    <img src="/static/images/services/ux-niall.jpg" alt="UX Design Whiteboard"
                                         className="img-fluid"/>
                                </div>
                                <div className="col-md-6">
                                    <img src="/static/images/services/ux-andy.jpg" alt="UX Design Whiteboard"
                                         className="img-fluid"/>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-5 offset-md-1 pr-5">
                            ...
                            <p className="mt-5">{this.props.description || 'We work with you to iterate on the various creative deliverables until you achieve your vision.'}</p>


                            {this.props.ProjectServiceListItem ? (
                                <div className="mt-5">
                                    <h6 className="title--project-section title--project-section--small text-grey mb0">What we did</h6>
